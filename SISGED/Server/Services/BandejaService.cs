    ...
    public class BandejaService
    {
        ...
        public async Task<BandejaESDTOR> ObtenerBandeja(string usuario)
        {
            ...
            listabandejas = await _bandejas.Aggregate()
                                        ...
                                        .Unwind<BandejaDTODocumentoExpediente, BandejaExpedienteDTO>(be => be.bandejadocumento.Documents, opcionesunwind2)
                                        ...
                                        .Unwind<BandejaDTOEDocumentoExpediente, BandejaExpedienteDTOE>(bee => bee.bandejadocumento.Documents, opcionesunwind6)
