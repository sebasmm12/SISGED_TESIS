...
namespace SISGED.Server.Services.Contracts
{
    public interface ITrayService : IGenericService
    {
        ...
        Task RegisterOutputTrayWithDocumentTrayAsync(DocumentTray document, string evaluatorUserId, string senderUserId);
        ...
        Task<IEnumerable<ExpiredTrayDocuments>> GetNextExpiredTraysDocumentsAsync(string userId);
