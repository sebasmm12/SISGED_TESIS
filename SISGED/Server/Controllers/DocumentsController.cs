...
namespace SISGED.Server.Controllers
{
    ...
    public class DocumentsController : ControllerBase
    {
        ...
        public DocumentsController(IDocumentService documentService, IDossierService dossierService, ITrayService trayService, IPublicDeedsService publicDeedsService, IFileStorage fileStorage, IAssistantService assistantService)
        {
