...
namespace SISGED.Client.Components.Documents.Updates;

public partial class ComplaintRequestUpdate
{
    [Inject]
    ...
    {
        return new() { Completed = "Completado", Finish = "Actualizar", Next = "Siguiente", Previous = "Anterior" };
    }
    ...
    private bool CheckComplaintRegisterAsync()
    {
        ...
        {
            SwalFireRepository
                .ShowErrorSwalFireAsync("No se puede actualizar la solicitud de Denuncia, por favor verifique los datos ingresados")
                .GetAwaiter();
